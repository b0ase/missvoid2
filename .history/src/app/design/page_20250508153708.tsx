...
Photograph presents studio lighting, high contrast. ${serialNumber} ${salt}`;
...
Photograph presents ${structuredPrompt.photography}. ${structuredPrompt.serialNumber} ${structuredPrompt.salt}`;
              ...
              <button
                className="bg-white text-black py-2 px-6 rounded hover:bg-gray-200 transition w-full"
