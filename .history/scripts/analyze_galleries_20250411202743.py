...
class GalleryAnalyzer:
    ...
    def generate_image_description(self, image_path: str) -> str:
        """Generate a description for an image using Hugging Face API."""
        try:
            ...
            with open(image_path, "rb") as image_file:
                ...
                print(f"API Key (first/last 4 chars): {HUGGING_FACE_API_KEY[:4]}...{HUGGING_FACE_API_KEY[-4:]}")
                ...
                if response.status_code == 503:
                    ...
                    return self.generate_image_description(image_path)  # Retry
    ...
    def _process_item(self, groups, gallery_name):
        ...
        if os.path.exists(image_path):
            ai_description = self.generate_image_description(image_path)
