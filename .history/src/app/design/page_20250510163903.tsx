...
export default function DesignPage() {
  const { currentUser, userProfile, isLoading: authIsLoading, login, signup, logout } = useAuth(); // Use the hook
            ...
            {authIsLoading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-1 bg-gray-900 p-6 rounded-lg border border-gray-700 text-center">
                  ...
                  <h3 className="text-xl font-medium text-white">{userProfile.fullName || 'MISS VOID Designer'}</h3>
                  <p className="text-sm text-purple-400 mt-1">{userProfile.email}</p>
                ...
                <div className="md:col-span-2 bg-gray-900 p-6 rounded-lg border border-gray-700">
                  <h3 className="text-lg font-medium text-white mb-4">Account Settings (Read-Only for now)</h3>
                  <div className="space-y-4">
                    ...
                    {/* Add more fields as needed, e.g., for updating password or other profile info */}
                    <div className="pt-2">
                  ...
                  <div className="mt-8">
                    ...
                    <div className="p-4 border border-gray-700 rounded-lg bg-gray-800">
                      <div className="flex justify-between items-center">
                        <div>
                          <h5 className="text-white font-medium">{userProfile.subscriptionTier || 'Free Tier'}</h5>
              ...
              // User is not logged in - display Login/Signup form
              <AuthForm /> // We will create this component next
            )}
          </div>
        )}
