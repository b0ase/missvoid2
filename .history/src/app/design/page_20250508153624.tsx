            ...
            <div className="bg-black p-6 rounded-lg mb-8 border border-gray-800">
              ...
              <div className="mb-4">
                ...
                <div className="mt-2 flex justify-between items-center">
                  ...
                  <div className="flex">
                    <button 
                      className="bg-gray-700 text-white px-3 py-1 rounded border border-gray-600 hover:bg-gray-600 transition text-sm flex items-center ml-4"
                      onClick={() => {
                        // Generate a serial number for this prompt
                        const serial = `#${String(promptCounter).padStart(3, '0')}`;
                        setPromptCounter(prev => prev + 1);
                        
                        // Create a structured prompt
                        const generatedPrompt = `A meticulously crafted MISS VOID ${productType} featuring ${PRODUCT_DESCRIPTORS[productType]?.slice(0, 2).join(', ')}. 
The design incorporates premium black leather, architectural silhouette, showcasing the brand's signature brutalist aesthetic. 
This piece exemplifies high-end alternative fashion. 
Photograph presents studio lighting, high contrast. ${serial}`;
                        
                        setPromptText(generatedPrompt);
                        
                        // Update structured prompt fields
                        setStructuredPrompt({
                          name: `A meticulously crafted MISS VOID ${productType}`,
                          description: `featuring ${PRODUCT_DESCRIPTORS[productType]?.slice(0, 2).join(', ')}`,
                          primaryMaterial: 'premium black leather',
                          secondaryMaterial: '',
                          influence: 'high-end alternative fashion',
                          hardware: 'hardware details',
                    ...
                    <button 
                      className="bg-gray-700 text-white px-3 py-1 rounded border border-gray-600 hover:bg-gray-600 transition text-sm ml-2"
                    ...
                    <div className="mt-3 flex justify-end">
                      <button 
                        ...
                        onClick={() => {
                          ...
                          const combinedPrompt = `${structuredPrompt.name} ${structuredPrompt.description}. 
