...
const allCategories: GalleryCategory[] = [
  ...
  {
    name: 'VOID BOOTS II',
    path: '/gallery/void-boots-ii',
    coverImage: '/images/void-boots/IMG_8015.JPG',
    isFeatured: false,
    type: 'fashion',
    imageCount: 30,
    description: 'The second installment of our acclaimed footwear collection, featuring 30 additional statement pieces. These architectural designs showcase innovative materials and structural elements.'
  },
  {
    name: 'VOID BOUDOIR',
