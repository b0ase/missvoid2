    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="mb-4 text-center">
          <Link href="/test" className="text-blue-600 hover:underline mr-4">View Image Test Page</Link>
          <Link href="/test2" className="text-blue-600 hover:underline">View ClientImage Test Page</Link>
        </div>
