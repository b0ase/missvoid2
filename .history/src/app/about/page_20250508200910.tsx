        ...
        <div className="mb-12 bg-gray-900 p-6 rounded-lg border border-gray-800">
          ...
          <div className="text-center mt-6 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <Link href="/contact" className="inline-block bg-white text-black py-2 px-6 rounded hover:bg-gray-200 transition w-full">
            ...
            <Link href="/design" className="inline-block bg-white text-black py-2 px-6 rounded hover:bg-gray-200 transition mt-4">
