...
export default function DesignPage() {
  ...
  const generateDetailedPrompt = () => {
    ...
    // Product-specific details - get from PRODUCT_DESCRIPTORS
    let specificDetails = "";
    
    // Get descriptors for the selected product type, or use default descriptors
    ...
    // Select 3-4 random descriptors for the product
    specificDetails = [...descriptors]
"use client";
