...
export default function DesignPage() {
  ...
  const generateDetailedPrompt = () => {
    ...
    const detailedPrompt = {
      ...
      brand: 'MISS VOID',
      description: `featuring ${specificDetails}`,
      primaryMaterial: "premium black leather",
      secondaryMaterial: "",
      ...
      serialNumber: `MV${String(promptCounter).padStart(3, '0')}`,
      salt: salt
    };
  ...
  const handleGeneratePrompt = () => {
    ...
    const textPrompt = `MISS VOID ${productType} "${generatedPrompt.name}" ${generatedPrompt.description}`;
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button 
                    ...
                    onClick={() => {
                      ...
                      const generatedPrompt = `MISS VOID ${productType} "${creativeProductName}" featuring ${PRODUCT_DESCRIPTORS[productType]?.slice(0, 2).join(', ')}. 
