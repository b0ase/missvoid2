...
export default function StudioPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-6 sm:py-8">
      <h1 className="text-3xl sm:text-4xl font-bold mb-4 sm:mb-8 text-center">MISS VOID STUDIO CONCEPT</h1>
      <p className="text-base sm:text-lg text-center mb-8 sm:mb-12 max-w-3xl mx-auto">
        Our conceptual photography studio showcases the MISS VOID aesthetic through digital artistry and creative visualization. 
        Each collection represents a unique exploration of form, shadow, and movement in this fictional fashion universe.
      </p>
