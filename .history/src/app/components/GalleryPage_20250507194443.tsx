...
export default function GalleryPage({ title, images, description, galleryName }: GalleryPageProps) {
  ...
  const handleDeleteImage = (imageSrc: string, e: React.MouseEvent) => {
    ...
    deleteImage(galleryName, imageSrc);
  };
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {isDevMode && (
        <div className="mb-4 p-2 bg-red-100 text-red-800 rounded-md">
          ...
          <p className="text-sm">You can delete images by hovering over them and clicking the X icon.</p>
        </div>
      )}
