...
export default function DesignPage() {
  ...
  const handleGeneratePrompt = () => {
    ...
    // Generate a verbose, creative description
    const verboseDescription = generateCreativeDescription(productType);
    
    // Extract structured data from the verbose description
    const extractedData = extractStructuredData(verboseDescription, productType);
                ...
                <div className="aspect-square max-h-[600px] w-full bg-gray-900 rounded-lg border border-gray-700 overflow-hidden">
                  {is3DConverting ? (
                    ...
                    <div className="w-full h-full">
                      {/* Display the 3D model using Three.js or an iframe viewer */}
                      <iframe 
                        src={`https://viewer.shapediver.com/v2/view?model=${encodeURIComponent(meshyModel.glbUrl)}`}
