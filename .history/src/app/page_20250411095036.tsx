    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
      <Link href="/gallery/void-chic" className="group">
        <div className="relative aspect-square overflow-hidden rounded-lg shadow-lg transition-transform duration-300 group-hover:scale-105">
          <Image
            src="/images/void-chic/IMG_1.JPG"
            alt="VOID CHIC"
            fill
      ...
      <Link href="/gallery/void-boudoir" className="group">
        <div className="relative aspect-square overflow-hidden rounded-lg shadow-lg transition-transform duration-300 group-hover:scale-105">
          <Image
            src="/images/void-boudoir/IMG_1.JPG"
            alt="VOID BOUDOIR"
            fill
            className="object-cover"
            priority
      ...
      <Link href="/gallery/void-muscles" className="group">
        <div className="relative aspect-square overflow-hidden rounded-lg shadow-lg transition-transform duration-300 group-hover:scale-105">
          <Image
            src="/images/void-muscles/IMG_1.JPG"
            alt="VOID MUSCLES"
            fill
            className="object-cover"
            priority
      ...
      <Link href="/gallery/void-industry" className="group">
        <div className="relative aspect-square overflow-hidden rounded-lg shadow-lg transition-transform duration-300 group-hover:scale-105">
          <Image
            src="/images/void-industry/IMG_1.JPG"
            alt="VOID INDUSTRY"
            fill
            className="object-cover"
            priority
      ...
      <Link href="/gallery/void-footwear" className="group">
        <div className="relative aspect-square overflow-hidden rounded-lg shadow-lg transition-transform duration-300 group-hover:scale-105">
          <Image
            src="/images/void-footwear/IMG_1.JPG"
            alt="VOID FOOTWEAR"
            fill
            className="object-cover"
            priority
      ...
      <Link href="/gallery/void-noire" className="group">
        <div className="relative aspect-square overflow-hidden rounded-lg shadow-lg transition-transform duration-300 group-hover:scale-105">
          <Image
            src="/images/void-noire/image-1.jpg"
            alt="VOID NOIRE"
            fill
            className="object-cover"
            priority
      ...
      <Link href="/gallery/void-xxx" className="group">
        <div className="relative aspect-square overflow-hidden rounded-lg shadow-lg transition-transform duration-300 group-hover:scale-105">
          <Image
            src="/images/void-xxx/image-1.jpg"
            alt="VOID XXX"
            fill
            className="object-cover"
            priority
      ...
      <Link href="/gallery/void-royale" className="group">
        <div className="relative aspect-square overflow-hidden rounded-lg shadow-lg transition-transform duration-300 group-hover:scale-105">
          <Image
            src="/images/void-royale/image-1.jpg"
            alt="VOID ROYALE"
            fill
            className="object-cover"
            priority
      ...
      <Link href="/gallery/miss-void" className="group">
        <div className="relative aspect-square overflow-hidden rounded-lg shadow-lg transition-transform duration-300 group-hover:scale-105">
          <Image
            src="/images/miss-void/IMG_7773.JPG"
            alt="MISS VOID"
            fill
            className="object-cover"
            priority
