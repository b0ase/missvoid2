      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-black p-6 rounded-lg border border-gray-800 mb-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-400">Utility Token for MISS VOID Ecosystem</p>
              </div>
            </div>
          ...
          {activeTab === 'overview' && (
            <div className="space-y-4">
              <p className="text-gray-300">
                $VOID is the native utility token of the MISS VOID design ecosystem. It powers transactions, grants access to exclusive designs, and allows holders to participate in governance decisions. Built on the Ethereum blockchain as an ERC-20 token, $VOID creates alignment between designers, manufacturers, and consumers.
              </p>
          ...
          {activeTab === 'utility' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-gray-900 p-4 rounded border border-gray-700">
                  <h3 className="text-lg font-medium text-white mb-2">Designer Verification</h3>
                  <p className="text-sm text-gray-400">
                    Verified designer status requires holding a minimum threshold of $VOID tokens, enabling premium distribution options.
                  </p>
                </div>
              </div>
            </div>
          ...
          {activeTab === 'acquire' && (
            <div className="space-y-6">
              <p className="text-gray-300">
                There are multiple ways to acquire $VOID tokens, depending on your preferences for centralized or decentralized exchanges.
              </p>
              ...
              <div className="bg-gray-900 p-4 rounded border border-gray-700">
                ...
                <p className="text-sm text-gray-400 mb-4">
                  $VOID is available on these decentralized exchanges:
                </p>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-gray-800 p-3 rounded border border-gray-700 flex items-center justify-center">
                  ...
                  <div className="bg-gray-800 p-3 rounded border border-gray-700 flex items-center justify-center">
                    <span className="text-white font-medium">SushiSwap</span>
                  </div>
                  <div className="bg-gray-800 p-3 rounded border border-gray-700 flex items-center justify-center">
                    <span className="text-white font-medium">1inch</span>
                  </div>
                  <div className="bg-gray-800 p-3 rounded border border-gray-700 flex items-center justify-center">
                    <span className="text-white font-medium">dYdX</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-900 p-4 rounded border border-gray-700 flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Connect your wallet to make purchases directly</p>
                </div>
          ...
          {activeTab === 'staking' && (
            <div className="space-y-6">
              <p className="text-gray-300">
                Staking $VOID tokens provides multiple benefits, including passive income, increased platform utility, and governance weight.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gray-900 p-4 rounded border border-gray-700">
                  ...
                  <ol className="space-y-2 text-sm text-gray-400 list-decimal pl-5">
                    <li>Connect your wallet containing $VOID tokens</li>
